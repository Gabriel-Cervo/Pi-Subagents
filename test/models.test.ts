...
const def = { name: "Explore", description: "", displayName: "Explore", tools: ["read"], enabled: true, prompt: "", source: "default", legacyFields: [], kind: "pi", model: "definition/model" } as AgentDefinition;
const settings = { version: 2, maxConcurrent: 4, joinMode: "smart", groupTimeoutMs: 1, allowCallerModelOverride: false, runTimeoutMs: 1800000, agentModels: { Explore: "global/model" } } as any;
